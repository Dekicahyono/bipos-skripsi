...
class BestPriceProductAdapter(private val onItemClicked: (product: Product) -> Unit) :
    RecyclerView.Adapter<BestPriceProductAdapter.ProductViewHolder>() {
    ...
    class ProductViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(product: Product) {
            ...
            itemView.tv_productPrice.text = Converter.rupiah(product.price.toDouble())
        }
